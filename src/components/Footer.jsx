      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16 mb-14 lg:mb-20">
        <div className="space-y-5 sm:col-span-2 lg:col-span-1">
          <div className="flex items-center">
            <img src="https://media.base44.com/images/public/69c2dfddddd2bac4ea658d31/8f15cbb61_CHLOGO.png" alt="Contemporary Homes" className="h-14 w-auto brightness-0 invert" />
          </div>
